...
module.exports = {
    ...
    callback: (message) => {
        ...
        if(message.mentions.users.size === 0){
            ...
            .setDescription(`<:emojino:779190801598775317> Please mention a user to remove role of!`)
            .setColor('RED')
        ...
        .setDescription(`<:emojiyes:779190801392861224> Successfully removed role of **${message.mentions.users.first().username}**!`)
        .setColor('GREEN')
        .setFooter('The EverythinBot')
        .setTimestamp()
